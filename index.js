...
const allowedOrigins = [
  ...
  "https://arthub-ohvfo56il-asmuals-projects.vercel.app",
  "https://arthub-git-main-asmuals-projects.vercel.app/",
];
...
// CRITICAL: Stripe webhook requires raw body — must come BEFORE express.json()
...
async function startServer() {
  try {
    ...
    // Share db instance across all route handlers
    app.set("db", db);
